...
public class Main {
	...
	public static void main(String[] args) {
        ...
        System.out.println("Veiculos de carga envolvidos no acidente na BR-101:");
        if (veiculosCargaEnvolvidosBr101 != null) {
            ...
            System.out.println("Nenhum veículo de carga envolvido no acidente na BR-101.");
        }

        List<Veiculo> veiculosCargaEnvolvidosBr116 = acidente2.listarVeiculosDeCargaEnvolvidos();
        System.out.println("Veiculos de carga envolvidos no acidente na BR-116:");
        if (veiculosCargaEnvolvidosBr116 != null) {
            for (Veiculo veiculo : veiculosCargaEnvolvidosBr116) {
                System.out.println("Veiculo de carga do ano " + veiculo.getAnoFabricacao());
            }
        } else {
            System.out.println("Nenhum veiculo de carga envolvido no acidente na BR-116.");
        }
        ...
        if (rodoviaComMaisAcidentesBicicletas != null) {
            ...
            System.out.println("Não ha informacoes suficientes para determinar a rodovia com mais acidentes de bicicleta.");
        }
        ...
        if (rodoviaComMaisVitimasFatais != null) {
            ...
            System.out.println("Não tem informacoes suficientes para determinar a rodovia com mais vitimas fatais.");
        }
	...
	private Object br116;
	
	List<Object> rodoviasComAcidentesNoCarnaval = Arrays.asList(br116, br116) 
            .stream()
            .filter(rodovia -> ((Rodovia) rodovia).getAcidentes().stream()
                    .anyMatch(acidente -> acidente.getMes() == 2))
